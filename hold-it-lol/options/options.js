...
const tabs = [
    ...
    },
    {
        ...
        items: [
            ...
            { key: 'mute-character', requires: 'list-moderation', title: 'Hide character', description: 'Someone\'s character is laggy or unpleasant? Mute just the character, while still seeing their messages.', preview: 'previews/placeholder.png' },
        ],
    },
    {
        title: 'New features',
